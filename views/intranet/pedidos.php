            ...
            <table class="items">
                <tbody class="mio">
                    ...
                    foreach ($pedidos as $pedido) {
                        ...
                        //echo '<td>'.MetodosComunes::sacar_total_pedido($pedido->idNTC_DocumentoVenta).' &euro;</td>';
                        ...
                        echo '<td><span class="boton fondo-azul tramitar" id="pedi_' . $pedido->idNTC_DocumentoVenta . '">Tramitar</span></td>';               
                        echo '</tr>';
