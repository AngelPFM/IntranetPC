		...
		?>
			<div class="row <?php echo ($cont%2==0 ? 'odd' : 'even'); ?>">
				...
				<?php foreach($idiomas as $idioma) { ?>
					...
					<input id="<?php echo $mensaje['id'].'_'.$idioma->idNTC_Idioma; ?>" type="text" <?php echo $width; ?> value="<?php echo htmlspecialchars($mensaje[$idioma->idNTC_Idioma]); ?>" idorigen="<?php echo $mensaje['id']; ?>" lang="<?php echo $idioma->idNTC_Idioma; ?>"></input>
				<?php } ?>
			</div>
		<?php $cont++; } ?>
	</div>
